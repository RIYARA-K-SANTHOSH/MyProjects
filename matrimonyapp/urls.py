...
urlpatterns = [
    ...
    path('add-match-preferences/', views.add_match_preferences, name='add_match_preferences'),
    path('matching-profiles/', views.add_match_preferences, name='matching_profiles'),
]
